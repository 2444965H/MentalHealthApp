...
social_advice_7 \
    = "\n Social Advice 7: When you are ready, try to analyze the situation & develop a strategy to deal with those exchanges."

social_advice_8 \
    = "\n Social Advice 8: Depending on the situation, try to resolve the negative social exchange with that person."

social_advice_9 \
    = "\n Social Advice 9: Practicing meditation and mindfulness can help you let go this situation so that it burdens you less."
