...
financial_advice_1 \
    = "Financial Advice 1: To ease the financial burden lastingly, you could start with basic budgeting! " \
...
financial_advice_3 \
    = "\n Financial Advice 3: If you are struggling heavily with finances, seek out help: " \
